...
export type LogisticsContext = { period: { startsOn: string; endsOn: string }; selectedCountryCode: string; members: unknown[]; budgetSummary?: { crewHardCeiling: number } | null; logistics?: unknown; attractionIds: string[]; importedPlaces?: { id: string }[] };
