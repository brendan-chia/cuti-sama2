...
const styles = StyleSheet.create({
  center: { alignItems: 'center', flex: 1, justifyContent: 'center', padding: spacing.xl }, back: { color: colors.sky, fontSize: typography.body, marginBottom: spacing.lg, minHeight: 44, paddingTop: spacing.sm }, header: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap', gap: spacing.md }, heading: { flex: 1 }, kicker: { color: colors.sky, fontSize: typography.label, fontWeight: '700', letterSpacing: 1.6 }, title: { color: colors.ink, fontSize: typography.title, fontWeight: '700', letterSpacing: -0.6, marginTop: spacing.sm }, connection: { alignItems: 'center', flexDirection: 'row', gap: spacing.xs }, dot: { backgroundColor: colors.disabled, borderRadius: radius.pill, height: 8, width: 8 }, live: { backgroundColor: colors.sky }, meta: { color: colors.textMuted, fontSize: typography.small }, intro: { color: colors.textMuted, fontSize: typography.body, lineHeight: 24, marginTop: spacing.sm, maxWidth: 520 }, motionNote: { color: colors.sky, fontSize: typography.small, marginTop: spacing.sm }, waiting: { backgroundColor: colors.surface, borderRadius: radius.lg, gap: spacing.sm, marginTop: spacing.xxl, padding: spacing.xl }, sectionTitle: { color: colors.ink, fontSize: typography.heading, fontWeight: '700' }, body: { color: colors.textMuted, fontSize: typography.body, lineHeight: 23 }, progress: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.xl }, progressText: { color: colors.coral, flex: 1, fontSize: typography.label, fontWeight: '700', letterSpacing: 1.1 }, progressCount: { color: colors.gold, fontSize: typography.label, fontWeight: '700' }, players: { gap: spacing.lg, paddingBottom: spacing.xl, paddingTop: spacing.lg }, player: { alignItems: 'center', width: 70 }, removed: { opacity: 0.45 }, avatar: { alignItems: 'center', backgroundColor: colors.surfaceTint, borderColor: colors.border, borderRadius: radius.pill, borderWidth: 2, height: 48, justifyContent: 'center', width: 48 }, readyAvatar: { borderColor: colors.sky }, avatarText: { color: colors.ink, fontSize: typography.body, fontWeight: '700' }, playerName: { color: colors.ink, fontSize: typography.label, fontWeight: '700', marginTop: spacing.sm, maxWidth: 70 }, playerState: { color: colors.textMuted, fontSize: typography.label, fontWeight: '700', marginTop: spacing.xs }, ready: { color: colors.sky }, roundTitle: { color: colors.ink, fontSize: typography.heading, fontWeight: '700' }, roundInstruction: { color: colors.textMuted, fontSize: typography.small, lineHeight: 20, marginBottom: spacing.lg, marginTop: spacing.xs }, complete: { backgroundColor: colors.surface, borderColor: colors.gold, borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, marginTop: spacing.xl, padding: spacing.xl }, waitText: { color: colors.textMuted, fontSize: typography.small, marginTop: spacing.xl, textAlign: 'center' }, error: { color: colors.danger, fontSize: typography.small, lineHeight: 19, marginTop: spacing.md, textAlign: 'center' }, footer: { gap: spacing.md },
});
