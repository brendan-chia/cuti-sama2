...
const styles = StyleSheet.create({
  topBar: { alignItems: 'center', backgroundColor: colors.midnight, flexDirection: 'row', minHeight: 58, paddingHorizontal: spacing.md },
  ...
  backIcon: { color: colors.white, fontSize: 34, fontWeight: '300', lineHeight: 36, marginTop: -2 },
  topTitle: { color: colors.white, flex: 1, fontSize: typography.body, fontWeight: '800', letterSpacing: .1 },
  topTrailing: { alignItems: 'center', flexDirection: 'row', gap: spacing.md, minWidth: 66, justifyContent: 'flex-end' },
  people: { color: colors.white, fontSize: 19 }, more: { color: colors.white, fontSize: 24, lineHeight: 26 },
  pressed: { opacity: .66, transform: [{ scale: .97 }] },
  bottomNav: { alignItems: 'flex-end', backgroundColor: colors.midnightRaised, borderTopColor: colors.border, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-around', minHeight: 66, paddingBottom: spacing.xs, paddingHorizontal: spacing.sm, paddingTop: spacing.sm },
  navItem: { alignItems: 'center', gap: 2, minWidth: 54 }, navGlyph: { color: colors.textMuted, fontSize: 19, lineHeight: 22 }, navLabel: { color: colors.textMuted, fontSize: 9, fontWeight: '600' }, navActive: { color: colors.sand },
  addButton: { alignItems: 'center', backgroundColor: colors.sky, borderColor: colors.sand, borderRadius: radius.pill, borderWidth: 1, height: 48, justifyContent: 'center', marginBottom: 6, width: 48 }, addGlyph: { color: colors.midnight, fontSize: 29, fontWeight: '300', lineHeight: 32 },
});
