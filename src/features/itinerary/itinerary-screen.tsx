...
const styles = StyleSheet.create({
  ...
  days: { gap: spacing.md, paddingBottom: spacing.xl, paddingHorizontal: spacing.md, paddingTop: spacing.lg }, day: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, borderRadius: radius.md, overflow: 'hidden', padding: spacing.md }, pressed: { opacity: .78, transform: [{ scale: .995 }] }, dayMeta: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between' }, dayLabel: { color: colors.sky, fontSize: 9, fontWeight: '800', letterSpacing: .7 }, dayTitle: { color: colors.ink, fontSize: typography.body, fontWeight: '800', marginTop: spacing.sm }, dayPrice: { backgroundColor: colors.background, borderColor: colors.gold, borderRadius: radius.sm, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: spacing.sm, paddingVertical: 4 }, dayPriceText: { color: colors.gold, fontSize: 8, fontWeight: '800' },
  timeline: { marginTop: spacing.md }, activity: { flexDirection: 'row', minHeight: 104 }, timelineRail: { alignItems: 'center', width: 44 }, activityIcon: { alignItems: 'center', backgroundColor: colors.leafSurface, borderRadius: radius.pill, height: 34, justifyContent: 'center', width: 34 }, activityIconWarm: { backgroundColor: colors.surfaceWarm }, activityGlyph: { color: colors.ink, fontSize: 15, fontWeight: '900' }, railLine: { backgroundColor: colors.border, flex: 1, marginVertical: 3, width: 1 }, activityCopy: { flex: 1, paddingBottom: spacing.md }, time: { color: colors.sky, fontSize: 9, fontWeight: '800' }, activityTitle: { color: colors.ink, fontSize: 12, fontWeight: '800', marginTop: 3 }, location: { color: colors.sky, fontSize: 9, marginTop: 3 }, estimate: { alignSelf: 'flex-start', backgroundColor: colors.surfaceTint, borderRadius: 4, color: colors.gold, fontSize: 8, fontWeight: '800', marginTop: 5, overflow: 'hidden', paddingHorizontal: 5, paddingVertical: 2 }, warning: { color: colors.gold, fontSize: typography.small, lineHeight: 18 }, source: { color: colors.textMuted, fontSize: 9, lineHeight: 15, marginTop: spacing.md, textAlign: 'center' },
});
