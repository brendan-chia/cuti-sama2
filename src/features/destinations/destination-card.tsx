...
const styles = StyleSheet.create({
  ...
  heading: { alignItems: 'flex-start', flexDirection: 'row', gap: spacing.md, justifyContent: 'space-between', flexWrap: 'wrap' }, nameBlock: { flex: 1, minWidth: 140 }, name: { color: colors.ink, fontSize: typography.heading, fontWeight: '900' }, country: { color: colors.textMuted, fontSize: typography.small, marginTop: spacing.xs },
  confidence: { backgroundColor: colors.surfaceTint, borderRadius: radius.sm, color: colors.sky, fontSize: typography.small, fontWeight: '900', overflow: 'hidden', paddingHorizontal: spacing.md, paddingVertical: spacing.sm }, low: { backgroundColor: colors.surfaceWarm, color: colors.ink },
