...
const styles = StyleSheet.create({
  card: { backgroundColor: colors.midnightRaised, borderColor: colors.border, borderRadius: radius.lg, borderWidth: 1, gap: spacing.md, padding: spacing.xl }, nearMatch: { borderColor: colors.gold },
  heading: { alignItems: 'flex-start', flexDirection: 'row', gap: spacing.md, justifyContent: 'space-between' }, nameBlock: { flex: 1 }, name: { color: colors.white, fontSize: typography.heading, fontWeight: '900' }, country: { color: colors.textMuted, fontSize: typography.small, marginTop: spacing.xs },
  confidence: { backgroundColor: colors.sky, borderRadius: radius.pill, color: colors.midnight, fontSize: 10, fontWeight: '900', overflow: 'hidden', paddingHorizontal: spacing.md, paddingVertical: spacing.sm }, low: { backgroundColor: colors.gold },
  metrics: { gap: spacing.md }, metric: { borderBottomColor: colors.border, borderBottomWidth: StyleSheet.hairlineWidth, gap: spacing.xs, paddingBottom: spacing.md }, label: { color: colors.gold, fontSize: typography.label, fontWeight: '900', letterSpacing: 1 }, value: { color: colors.white, fontSize: typography.small, lineHeight: 20 }, reason: { color: colors.white, fontSize: typography.small, lineHeight: 20 }, muted: { color: colors.textMuted, fontSize: typography.small },
  tags: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, tag: { backgroundColor: colors.midnightSoft, borderRadius: radius.pill, color: colors.white, fontSize: typography.label, overflow: 'hidden', paddingHorizontal: spacing.md, paddingVertical: spacing.sm }, space: { marginTop: spacing.sm },
  compromise: { backgroundColor: colors.midnightSoft, borderRadius: radius.md, gap: spacing.sm, padding: spacing.lg }, warning: { color: colors.gold, fontSize: typography.small, lineHeight: 20 }, excluded: { color: colors.danger, fontSize: typography.label, fontWeight: '900' }, provenance: { gap: spacing.xs }, provenanceLine: { color: colors.textMuted, fontSize: typography.label, lineHeight: 17 },
});
