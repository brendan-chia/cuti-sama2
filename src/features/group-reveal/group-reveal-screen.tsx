...
const styles = StyleSheet.create({
  ...
  title: { color: colors.white, fontSize: typography.title, fontWeight: '900', marginTop: spacing.sm }, intro: { color: colors.textMuted, fontSize: typography.body, lineHeight: 24, marginTop: spacing.md },
  status: { borderRadius: radius.lg, borderWidth: 1, gap: spacing.sm, marginTop: spacing.xl, padding: spacing.xl }, matched: { backgroundColor: colors.midnightRaised, borderColor: colors.sky }, blocked: { backgroundColor: colors.midnightRaised, borderColor: colors.danger },
  statusTitle: { color: colors.white, fontSize: typography.heading, fontWeight: '800' }, body: { color: colors.textMuted, fontSize: typography.small, lineHeight: 20 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.sm }, blockingChip: { backgroundColor: colors.coral, borderRadius: radius.pill, color: colors.midnight, fontSize: 10, fontWeight: '900', overflow: 'hidden', paddingHorizontal: spacing.md, paddingVertical: spacing.sm },
  section: { gap: spacing.md, marginTop: spacing.xxl }, sectionTitle: { color: colors.white, fontSize: typography.heading, fontWeight: '800' }, empty: { color: colors.textMuted, fontSize: typography.small },
  fact: { backgroundColor: colors.midnightRaised, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, padding: spacing.lg }, dealbreaker: { borderColor: colors.coral }, factTitle: { color: colors.gold, fontSize: typography.small, fontWeight: '800' }, factDetail: { color: colors.white, fontSize: typography.body, lineHeight: 23, marginTop: spacing.sm }, sourceLink: { color: colors.sky, fontSize: typography.small, fontWeight: '700', marginTop: spacing.md },
  sourceList: { gap: spacing.sm, marginTop: spacing.md }, source: { backgroundColor: colors.midnightSoft, borderRadius: radius.sm, gap: spacing.xs, padding: spacing.md }, sourceAttribution: { color: colors.gold, fontSize: typography.label, fontWeight: '800' }, sourceValue: { color: colors.white, fontSize: typography.small, lineHeight: 19 }, sourceMeta: { color: colors.textMuted, fontSize: 10, textTransform: 'uppercase' },
