...
export function VideoImportPanel({tripId,sourceUrl,caption,disabled,onConfirmed,onFallback}:{tripId:string;sourceUrl:string;caption:string;disabled?:boolean;onConfirmed:(room:QuestRoom)=>void;onFallback?:()=>void}){
