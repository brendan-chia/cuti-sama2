...
function CountryAttractionMap({ country, selectedIds, onToggle, disabled = false }: Props) {
  ...
  return <View style={styles.container} testID="attraction-map">
    ...
    <View style={styles.map} testID="country-map-viewport" onLayout={(event) => setWidth(event.nativeEvent.layout.width)}>
      ...
      {pending && <View pointerEvents="none" style={styles.loading}><ActivityIndicator size="small" color={colors.midnight} /><Text style={styles.loadingText}>Loading map…</Text></View>}
...
const styles = StyleSheet.create({
  ...
  mapControl: { backgroundColor: colors.white, borderWidth: 1, borderColor: '#D5D8C9', borderRadius: radius.sm, width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  controlText: { color: colors.midnight, fontSize: 27, lineHeight: 30, fontWeight: '600' },
  recenterText: { color: colors.midnight, fontSize: 26 },
  attribution: { position: 'absolute', bottom: 0, right: 0, backgroundColor: colors.white, minHeight: 44, justifyContent: 'center', paddingHorizontal: spacing.sm },
  attributionText: { fontSize: 10, color: colors.midnight, textDecorationLine: 'underline' },
  pin: { position: 'absolute', width: 40, height: 40, backgroundColor: colors.coral, borderColor: colors.white, borderWidth: 2, borderRadius: 20, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
  pinSelected: { backgroundColor: colors.midnight, zIndex: 2 },
  pinText: { fontSize: 16, fontWeight: '900', color: colors.midnight },
  ...
  pinTailSelected: { backgroundColor: colors.midnight },
  loading: { position: 'absolute', left: spacing.sm, top: spacing.sm, backgroundColor: colors.white, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radius.sm, padding: spacing.sm },
  loadingText: { color: colors.midnight, fontSize: typography.small },
  ...
  unavailableTitle: { color: colors.midnight, fontSize: typography.body, fontWeight: '800' },
  unavailableBody: { color: colors.midnightSoft, fontSize: typography.small, lineHeight: 18, marginTop: spacing.xs },
  ...
  listNumber: { backgroundColor: colors.midnightRaised, borderColor: colors.border, borderWidth: 1, borderRadius: 18, width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  listNumberSelected: { backgroundColor: colors.sky, borderColor: colors.sky },
  numberText: { color: colors.white, fontSize: typography.body, fontWeight: '800' },
  numberTextSelected: { color: colors.midnight },
  attractionCopy: { flex: 1, gap: spacing.xs },
  category: { color: colors.coral, fontSize: typography.label, fontWeight: '800', letterSpacing: 1 },
  attractionName: { color: colors.white, fontSize: typography.body, fontWeight: '800' },
