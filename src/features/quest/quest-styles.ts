...
export const questStyles = StyleSheet.create({
  ...
  title: { color: colors.ink, fontSize: 28, fontWeight: '700', letterSpacing: -1, lineHeight: 34 },
  ...
  panel: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: spacing.xl, gap: spacing.md },
  ...
  chip: { borderColor: colors.border, borderWidth: 1, borderRadius: radius.sm, paddingHorizontal: spacing.lg, minHeight: 48, justifyContent: 'center' },
