...
const styles = StyleSheet.create({
  ...
  stamp: { position: 'absolute', top: 85, left: 24, backgroundColor: colors.sky, borderRadius: 6, padding: 16, transform: [{ rotate: '-12deg' }] }, passStamp: { backgroundColor: colors.coral }, stampText: { color: colors.paper, fontSize: 26, fontWeight: '900' },
  ...
  voteButtons: { flexDirection: 'row', gap: spacing.md }, voteButton: { minHeight: 62, borderRadius: radius.md, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.md }, pass: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border }, agree: { backgroundColor: colors.action, borderWidth: 1, borderColor: colors.sky }, passText: { fontSize: 30, color: colors.danger }, agreeIcon: { color: colors.onAction, fontSize: 25 }, agreeText: { color: colors.onAction, fontWeight: '800' }, swipeHint: { color: colors.textMuted, fontSize: 12, textAlign: 'center', lineHeight: 20 },
});
