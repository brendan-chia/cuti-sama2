...
const styles = StyleSheet.create({
  ...
  card: { overflow: 'hidden', borderRadius: 20, backgroundColor: colors.sand }, photo: { height: 160, backgroundColor: colors.midnightSoft, alignItems: 'center', justifyContent: 'center' }, fallbackFlag: { fontSize: 80 },
  photoTag: { position: 'absolute', top: spacing.lg, left: spacing.lg, backgroundColor: colors.overlay, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: 6 }, photoTagText: { color: colors.white, fontSize: 9, fontWeight: '800', letterSpacing: 1.5 },
  stamp: { position: 'absolute', top: 85, left: 24, backgroundColor: colors.sky, borderRadius: 6, padding: 16, transform: [{ rotate: '-12deg' }] }, passStamp: { backgroundColor: colors.coral }, stampText: { color: colors.midnight, fontSize: 26, fontWeight: '900' },
  caption: { padding: spacing.lg, gap: spacing.sm }, countryTitle: { color: colors.midnight, fontSize: 29, fontWeight: '900', letterSpacing: -0.7 }, tagline: { color: colors.midnightRaised, fontSize: 13, lineHeight: 19 },
  voteButtons: { flexDirection: 'row', gap: spacing.md }, voteButton: { minHeight: 62, borderRadius: radius.md, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.md }, pass: { backgroundColor: colors.midnightRaised, borderWidth: 1, borderColor: colors.border }, agree: { backgroundColor: colors.sky }, passText: { fontSize: 30, color: colors.danger }, agreeIcon: { color: colors.midnight, fontSize: 25 }, agreeText: { color: colors.midnight, fontWeight: '800' }, swipeHint: { color: colors.textMuted, fontSize: 12, textAlign: 'center', lineHeight: 20 },
});
