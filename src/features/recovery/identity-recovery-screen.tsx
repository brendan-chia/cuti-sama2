...
const styles = StyleSheet.create({ kicker: { color: colors.coral, fontSize: typography.label, fontWeight: '900', letterSpacing: 1.4 }, title: { color: colors.ink, fontSize: typography.title, fontWeight: '900', lineHeight: 35, marginTop: spacing.md }, body: { color: colors.textMuted, fontSize: typography.body, lineHeight: 24, marginTop: spacing.md }, notice: { backgroundColor: colors.surface, borderColor: colors.gold, borderRadius: radius.lg, borderWidth: 1, marginTop: spacing.xxl, padding: spacing.xl }, noticeTitle: { color: colors.gold, fontSize: typography.heading, fontWeight: '900' }, actions: { gap: spacing.md, marginTop: spacing.xxl }, error: { color: colors.danger, fontSize: typography.small, marginTop: spacing.lg } });
