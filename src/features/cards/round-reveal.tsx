...
const styles = StyleSheet.create({ reveal: { marginTop: spacing.lg }, kicker: { color: colors.gold, fontSize: typography.label, fontWeight: '900', letterSpacing: 1.2 }, title: { color: colors.ink, fontSize: typography.heading, fontWeight: '900', marginTop: spacing.sm }, summary: { color: colors.textMuted, fontSize: typography.body, lineHeight: 23, marginTop: spacing.sm }, cards: { gap: spacing.md, marginTop: spacing.lg }, card: { backgroundColor: colors.surface, borderRadius: radius.md, borderTopWidth: 3, padding: spacing.lg }, name: { color: colors.textMuted, fontSize: typography.label, fontWeight: '800' }, choice: { color: colors.ink, fontSize: typography.body, fontWeight: '900', marginTop: spacing.sm }, meaning: { color: colors.textMuted, fontSize: typography.small, marginTop: spacing.xs } });
