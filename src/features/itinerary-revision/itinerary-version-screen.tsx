...
export function ItineraryVersionScreen({ tripId, version, initialDay = 1, onBack, onRevise, onVersion, loadAction = loadRevisionState, loadVersionAction = loadItineraryVersion, activateAction = activateItinerary }: Props) {
  ...
  return <Screen contentStyle={styles.content} testID="itinerary-version-screen">
    ...
    <View style={styles.main} testID={`day-${day.dayNumber}`}>
      ...
      <View style={styles.budget}><Text style={styles.budgetTitle}>Budget summary</Text><View style={styles.budgetRow}><Text style={styles.budgetLabel}>Estimated range</Text><Text style={styles.budgetValue}>{estimateLabel(totals)}</Text></View></View>
...
const styles = StyleSheet.create({
  ...
  dayTabs: { gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.md }, dayTab: { minHeight: 48, alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.border, borderRadius: radius.sm, borderWidth: 1, minWidth: 58, paddingHorizontal: spacing.sm, paddingVertical: spacing.sm }, dayTabActive: { backgroundColor: colors.sand, borderColor: colors.sand }, dayTabTitle: { color: colors.ink, fontSize: 14, fontWeight: '800' }, dayTabTitleActive: { color: colors.ink }, dayTabDate: { color: colors.textMuted, fontSize: 14, marginTop: 3 }, dayTabDateActive: { color: colors.disabled },
  main: { paddingBottom: spacing.xxl, paddingHorizontal: spacing.md }, dayLabel: { color: colors.sky, fontSize: 14, fontWeight: '800', letterSpacing: .7, marginTop: spacing.sm }, dayHeading: { alignItems: 'center', flexDirection: 'row', gap: spacing.sm, justifyContent: 'space-between', marginTop: spacing.sm }, dayTitle: { color: colors.sky, flex: 1, fontSize: typography.heading, fontWeight: '900' }, priceBadge: { backgroundColor: colors.surface, borderColor: colors.gold, borderRadius: radius.sm, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: spacing.sm, paddingVertical: 4 }, priceBadgeText: { color: colors.gold, fontSize: 14, fontWeight: '800' },
  activities: { gap: spacing.sm, marginTop: spacing.lg }, activity: { flexDirection: 'row' }, timeRail: { alignItems: 'center', paddingVertical: spacing.sm, width: 48 }, time: { color: colors.sky, fontSize: 14, fontWeight: '800' }, timeDash: { backgroundColor: colors.border, flex: 1, marginVertical: 4, width: 1 }, activityCard: { flexWrap: 'wrap', gap: 12, backgroundColor: colors.surface, borderRadius: radius.md, flex: 1, flexDirection: 'row', minHeight: 128, overflow: 'hidden', padding: spacing.md }, activityCopy: { flexGrow: 1, flexBasis: 160, paddingRight: spacing.sm }, activityTitle: { color: colors.ink, fontSize: 18, fontWeight: '900' }, location: { color: colors.sky, fontSize: 14, marginTop: 3 }, body: { color: colors.textMuted, fontSize: 14, lineHeight: 22, marginTop: 5 }, activityMeta: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md, marginTop: 'auto', paddingTop: spacing.sm }, metaItem: { color: colors.sky, fontSize: 8 }, photo: { backgroundColor: colors.surfaceTint, borderRadius: radius.sm, height: 104, width: 82 },
  sectionLabel: { color: colors.sky, fontSize: 14, fontWeight: '800', marginTop: spacing.lg }, note: { alignItems: 'flex-start', backgroundColor: colors.surface, borderRadius: radius.sm, flexDirection: 'row', gap: spacing.sm, marginTop: spacing.sm, padding: spacing.md }, noteIcon: { color: colors.sky, fontSize: 13 }, noteText: { color: colors.textMuted, flex: 1, fontSize: 14, lineHeight: 22 }, budget: { backgroundColor: colors.surface, borderRadius: radius.sm, marginTop: spacing.md, padding: spacing.md }, budgetTitle: { color: colors.sky, fontSize: 14, fontWeight: '800' }, budgetRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.sm }, budgetLabel: { color: colors.textMuted, fontSize: 9 }, budgetValue: { color: colors.sky, fontSize: 14, fontWeight: '900' }, budgetTrack: { backgroundColor: colors.border, borderRadius: radius.pill, height: 5, marginTop: spacing.sm, overflow: 'hidden' }, budgetFill: { backgroundColor: colors.sand, borderRadius: radius.pill, height: 5, width: '62%' },
