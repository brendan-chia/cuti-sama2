...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 0, paddingTop: 0 }, back: { color: colors.sky, fontSize: typography.body, marginBottom: spacing.xl }, title: { color: colors.white, fontSize: typography.title, fontWeight: '900' },
  dayTabs: { gap: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.md }, dayTab: { alignItems: 'center', backgroundColor: colors.midnightRaised, borderColor: colors.border, borderRadius: radius.sm, borderWidth: 1, minWidth: 58, paddingHorizontal: spacing.sm, paddingVertical: spacing.sm }, dayTabActive: { backgroundColor: colors.sand, borderColor: colors.sand }, dayTabTitle: { color: colors.white, fontSize: 10, fontWeight: '800' }, dayTabTitleActive: { color: colors.midnight }, dayTabDate: { color: colors.textMuted, fontSize: 8, marginTop: 3 }, dayTabDateActive: { color: colors.disabled },
  main: { paddingBottom: spacing.xxl, paddingHorizontal: spacing.md }, dayLabel: { color: colors.sky, fontSize: 10, fontWeight: '800', letterSpacing: .7, marginTop: spacing.sm }, dayHeading: { alignItems: 'center', flexDirection: 'row', gap: spacing.sm, justifyContent: 'space-between', marginTop: spacing.sm }, dayTitle: { color: colors.sand, flex: 1, fontSize: typography.heading, fontWeight: '900' }, priceBadge: { backgroundColor: colors.midnightRaised, borderColor: colors.gold, borderRadius: radius.sm, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: spacing.sm, paddingVertical: 4 }, priceBadgeText: { color: colors.gold, fontSize: 8, fontWeight: '800' },
  activities: { gap: spacing.sm, marginTop: spacing.lg }, activity: { flexDirection: 'row' }, timeRail: { alignItems: 'center', paddingVertical: spacing.sm, width: 48 }, time: { color: colors.sky, fontSize: 9, fontWeight: '800' }, timeDash: { backgroundColor: colors.border, flex: 1, marginVertical: 4, width: 1 }, activityCard: { backgroundColor: colors.midnightRaised, borderRadius: radius.md, flex: 1, flexDirection: 'row', minHeight: 128, overflow: 'hidden', padding: spacing.md }, activityCopy: { flex: 1, paddingRight: spacing.sm }, activityTitle: { color: colors.white, fontSize: 12, fontWeight: '900' }, location: { color: colors.sand, fontSize: 9, marginTop: 3 }, body: { color: colors.textMuted, fontSize: 10, lineHeight: 15, marginTop: 5 }, activityMeta: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md, marginTop: 'auto', paddingTop: spacing.sm }, metaItem: { color: colors.sand, fontSize: 8 }, photo: { backgroundColor: colors.midnightSoft, borderRadius: radius.sm, height: 104, width: 82 },
  sectionLabel: { color: colors.sand, fontSize: 11, fontWeight: '800', marginTop: spacing.lg }, note: { alignItems: 'flex-start', backgroundColor: colors.midnightRaised, borderRadius: radius.sm, flexDirection: 'row', gap: spacing.sm, marginTop: spacing.sm, padding: spacing.md }, noteIcon: { color: colors.sky, fontSize: 13 }, noteText: { color: colors.textMuted, flex: 1, fontSize: 10, lineHeight: 15 }, budget: { backgroundColor: colors.midnightRaised, borderRadius: radius.sm, marginTop: spacing.md, padding: spacing.md }, budgetTitle: { color: colors.sand, fontSize: 11, fontWeight: '800' }, budgetRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.sm }, budgetLabel: { color: colors.textMuted, fontSize: 9 }, budgetValue: { color: colors.sky, fontSize: 9, fontWeight: '900' }, budgetTrack: { backgroundColor: colors.border, borderRadius: radius.pill, height: 5, marginTop: spacing.sm, overflow: 'hidden' }, budgetFill: { backgroundColor: colors.sand, borderRadius: radius.pill, height: 5, width: '62%' },
  notice: { backgroundColor: colors.midnightRaised, borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, marginTop: spacing.lg, padding: spacing.md }, noticeTitle: { color: colors.white, fontSize: typography.body, fontWeight: '800' }, action: { marginTop: spacing.lg }, history: { gap: spacing.sm, marginTop: spacing.xxl }, sectionTitle: { color: colors.white, fontSize: typography.heading, fontWeight: '900' }, historyRow: { backgroundColor: colors.midnightRaised, borderColor: colors.border, borderRadius: radius.sm, borderWidth: 1, gap: spacing.xs, padding: spacing.md }, activeRow: { borderColor: colors.sky }, historyTitle: { color: colors.white, fontSize: typography.body, fontWeight: '800' }, error: { color: colors.danger, fontSize: typography.small, lineHeight: 20, marginTop: spacing.lg },
});
