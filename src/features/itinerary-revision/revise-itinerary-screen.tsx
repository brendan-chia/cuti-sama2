...
const styles = StyleSheet.create({ back: { color: colors.sky, fontSize: typography.body, marginBottom: spacing.xl }, kicker: { color: colors.coral, fontSize: typography.label, fontWeight: '900', letterSpacing: 1.4 }, title: { color: colors.white, fontSize: typography.title, fontWeight: '900', marginTop: spacing.sm }, intro: { color: colors.textMuted, fontSize: typography.body, lineHeight: 24, marginTop: spacing.md }, body: { color: colors.textMuted, fontSize: typography.small, lineHeight: 20 }, choices: { gap: spacing.md, marginTop: spacing.xl }, choice: { borderColor: colors.border, borderRadius: radius.md, borderWidth: 1, gap: spacing.xs, padding: spacing.lg }, choiceSelected: { backgroundColor: colors.midnightRaised, borderColor: colors.coral }, choiceTitle: { color: colors.white, fontSize: typography.body, fontWeight: '800' }, paces: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.lg }, pace: { borderColor: colors.border, borderRadius: radius.pill, borderWidth: 1, flex: 1, padding: spacing.md }, paceSelected: { backgroundColor: colors.coral, borderColor: colors.coral }, paceText: { color: colors.white, fontSize: typography.small, fontWeight: '800', textAlign: 'center', textTransform: 'capitalize' }, fields: { gap: spacing.lg, marginTop: spacing.xl }, action: { marginTop: spacing.lg }, errorBox: { borderColor: colors.danger, borderRadius: radius.md, borderWidth: 1, marginTop: spacing.lg, padding: spacing.md }, error: { color: colors.danger, fontSize: typography.small, lineHeight: 20 }, preview: { marginTop: spacing.xl }, estimateCard: { backgroundColor: colors.midnightRaised, borderRadius: radius.lg, gap: spacing.sm, padding: spacing.xl }, estimateLabel: { color: colors.coral, fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, estimateBefore: { color: colors.textMuted, fontSize: typography.small, textDecorationLine: 'line-through' }, estimateAfter: { color: colors.gold, fontSize: typography.heading, fontWeight: '900' }, changedDay: { borderBottomColor: colors.border, borderBottomWidth: 1, gap: spacing.sm, paddingVertical: spacing.xl }, dayTitle: { color: colors.white, fontSize: typography.heading, fontWeight: '900' }, change: { color: colors.sky, fontSize: typography.small, fontWeight: '800' }, summary: { color: colors.sand, fontSize: typography.body, lineHeight: 24, marginTop: spacing.xl } });
