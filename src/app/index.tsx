...
const styles = StyleSheet.create({
  ...
  brandRow: { flexDirection: 'row', gap: spacing.lg, justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.surfaceTint, borderColor: colors.border, borderWidth: 1, borderRadius: radius.lg, paddingHorizontal: spacing.lg, paddingVertical: spacing.lg },
  ...
  actionPanel: { borderWidth: 1, borderColor: colors.border, gap: spacing.md, backgroundColor: colors.surface, padding: 20, borderRadius: 24 },
  promiseRow: {
