...
const backgrounds = ['#D8E8B8', '#F6C38E', '#F8E7BF', '#C4D7A0', '#ACCC75'];
...
export function FlightStopIcon({ index }: { index: number }) {
  return <Svg width={38} height={38} viewBox="0 0 48 48" aria-hidden={true}>
    ...
    <G stroke="#563D2D" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      {index === 0 ? <>
      ...
      {index === 1 ? <>
        ...
        <Path d="M35 27H15L9 32L15 37H35Z" fill="#D8E8B8" />
      </> : null}
      {index === 2 ? <>
        <Rect x="9" y="10" width="30" height="29" rx="4" fill="#FFF9E5" />
        <Circle cx="29" cy="19" r="4" fill="#F58A24" stroke="none" />
        <Path d="M11 34L20 23L27 30L31 25L37 32V37H11Z" fill="#7D9C4C" />
      </> : null}
      {index === 3 ? <>
        <Path d="M12 16L31 10V21H12Z" fill="#FFF0C4" />
        <Rect x="9" y="17" width="29" height="22" rx="4" fill="#8EBA46" />
        <Path d="M30 24H40V33H30Q26 28.5 30 24Z" fill="#EAF1D8" />
        <Circle cx="32" cy="28.5" r="1.4" fill="#563D2D" stroke="none" />
      </> : null}
      {index === 4 ? <>
